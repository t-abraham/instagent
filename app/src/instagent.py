...
class instagent:
    ...
    def __init__(self, target, is_file, is_json, is_cli, output_dir, clear_cookies, is_timeout, main_dir):
        ...
        try:
            ...
            self.output_dir = self.main_dir.joinpath(self.output_dir)
        ...
        u = config.getUsername(self.main_dir.joinpath("config","credentials.ini"))
        p = config.getPassword(self.main_dir.joinpath("config","credentials.ini"))
    ...
    def set_timeout(self):
        pc.printout("Insert new input timeout in seconds: ", pc.YELLOW)
    ...
    def get_addrs(self):
        ...
        if len(sort_addresses) > 0:
            ...
            if self.writeFile:                
                file_name = self.output_dir.joinpath(self.target + "_addrs.txt")
                if file_name.exists():
                    file_name.unlink() 
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_addrs.json")
    ...
    def get_comment_data(self):
        ...
        print(t)
        if self.writeFile:
            file_name = self.output_dir.joinpath(self.target + "_comment_data.txt")
            if file_name.exists():
                file_name.unlink()
        ...
        if self.jsonDump:
            json_file_name = self.output_dir.joinpath(self.target + "_comment_data.json")
            if json_file_name.exists():
                json_file_name.unlink()
            with open(json_file_name, 'w') as f:
                f.write("{ \"Comments\":[ \n")
    ...
    def get_hashtags(self):
        ...
        if len(hashtags) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_hashtags.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_hashtags.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_user_info(self):
        try:
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_info.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(user, f)
    ...
    def get_total_likes(self):
        ...
        if self.writeFile:
            file_name = self.output_dir.joinpath(self.target + "_likes.txt")
            if file_name.exists():
                file_name.unlink() 
            file = open(file_name, "w")
        ...
        if self.jsonDump:
            ...
            json_file_name = self.output_dir.joinpath(self.target + "_likes.json")
            if json_file_name.exists():
                json_file_name.unlink()
            with open(json_file_name, 'w') as f:
                json.dump(json_data, f)
    ...
    def get_media_type(self):
        ...
        if counter > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_mediatype.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_mediatype.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_people_who_commented(self):
        ...
        if len(users) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_users_who_commented.txt")
                if file_name.exists():
                    file_name.unlink() 
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_users_who_commented.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_people_who_tagged(self):
        ...
        if len(posts) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_users_who_tagged.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_users_who_tagged.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_photo_description(self):
        ...
        if len(dd) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_photodes.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_descriptions.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_user_photo(self):
        ...
        pc.printout("\nWoohoo! We downloaded " + str(counter) + " photos (saved in " + str(self.output_dir) + " folder) \n", pc.GREEN)
    ...
    def get_user_propic(self):
        ...
        try:
            ...
            if URL != "":
                file_name = self.output_dir.joinpath(self.target + "_propic.jpg")                    
                if not file_name.exists():
                    urllib.request.urlretrieve(URL, file_name)
        ...
        if data['items'] is not None:  # no stories avaibile
            ...
            for i in data['items']:
                ...
                if i["media_type"] == 1:  # it's a photo
                    url = i['image_versions2']['candidates'][0]['url']
                    file_name = self.output_dir.joinpath(self.target + "_" + story_id + ".jpg")                    
                    if not file_name.exists():
                        urllib.request.urlretrieve(url, file_name)

                elif i["media_type"] == 2:  # it's a gif or video
                    url = i['video_versions'][0]['url']
                    file_name = self.output_dir.joinpath(self.target + "_" + story_id + ".mp4")                    
                    if not file_name.exists():
                        urllib.request.urlretrieve(url, file_name)
    ...
    def get_people_tagged_by_user(self):
        ...
        if len(ids) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_tagged.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_tagged.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_user(self, username):
        try:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_user_id.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
            ...
            pc.printout('Target - ClientError {0!s} (Code: {1:d}, Response: {2!s})'.format(e.msg, e.code, e.error_response), pc.RED)
            pc.printout("\n")
            error = json.loads(e.error_response)
            if 'message' in error:
                print(error['message'])
    ...
    def login(self, u, p):
        try:
            settings_file = self.main_dir.joinpath("config","settings.json")
            ...
            pc.printout('User - ClientError {0!s} (Code: {1:d}, Response: {2!s})'.format(e.msg, e.code, e.error_response), pc.RED)
            error = json.loads(e.error_response)
            pc.printout("\n")
    ...
    def check_private_profile(self):
        if self.is_private and not self.following:
            ...
            send = self.timedinput("Do you want send a follow request? [Y/N]: ",default="n")
            if send.lower() == "y":
    ...
    def get_fwersemail(self):
        ...
        try:
            ...
            value = self.timedinput(default="y")
            ...
            if value == str("y") or value == str("yes") or value == str("Yes") or value == str("YES"):
                ...
                while True:
                    try:
                        ...
                        new_value = int(self.timedinput(default=1))
                        value = new_value - 1
                        break
                    except ValueError:
        ...
        if len(results) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_fwersemail.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_fwersemail.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_fwingsemail(self):
        ...
        if len(results) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_fwingsemail.txt")
                if file_name.exists():
                    file_name.unlink() 
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_fwingsemail.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_fwingsnumber(self):
        ...
        if len(results) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_fwingsnumber.txt")
                if file_name.exists():
                    file_name.unlink()
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                ...
                json_file_name = self.output_dir.joinpath(self.target + "_fwingsnumber.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def get_fwersnumber(self):
        ...
        if len(results) > 0:
            ...
            if self.writeFile:
                file_name = self.output_dir.joinpath(self.target + "_fwersnumber.txt")
                if file_name.exists():
                    file_name.unlink() 
                file = open(file_name, "w")
                file.write(str(t))
            ...
            if self.jsonDump:
                json_data['followings_phone_numbers'] = results
                json_file_name = self.output_dir.joinpath(self.target + "_fwerssnumber.json")
                if json_file_name.exists():
                    json_file_name.unlink()
                with open(json_file_name, 'w') as f:
                    json.dump(json_data, f)
    ...
    def clear_cache(self):
        try:
            f = open(self.main_dir.joinpath("config","settings.json"),'w')
            f.write("{}")
    ...
    def timedinput(self, prompt="", default=""):
        try:
            var = inputimeout(prompt=str(prompt) + " [{} seconds timeout]".format(self.timeout), timeout=self.timeout)
